      ...
      <View style={styles.actions}>
        <TouchableOpacity style={styles.actionButton} onPress={handleLike}>
          <Animated.View style={[styles.actionIcon, animatedLikeStyle]}>
            <Icon name="heart-outline" size={20} color={getColor('textSecondary')} />
          </Animated.View>
        ...
        <TouchableOpacity style={styles.actionButton} onPress={onComment}>
          <Icon name="chatbubble-outline" size={20} color={getColor('textSecondary')} />
        ...
        <TouchableOpacity style={styles.actionButton} onPress={onShare}>
          <Icon name="share-outline" size={20} color={getColor('textSecondary')} />
