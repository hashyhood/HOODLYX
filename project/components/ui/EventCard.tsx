      ...
      <View style={styles.content}>
        ...
        <View style={styles.details}>
          <View style={styles.detailItem}>
            <Icon name="calendar-outline" size={16} color={getColor('textTertiary')} />
          ...
          <View style={styles.detailItem}>
            <Icon name="pin-outline" size={16} color={getColor('textTertiary')} />
            <Text style={[styles.detailText, { color: getColor('textSecondary') }]}>
              {event.location}
            </Text>
          </View>
          ...
          <View style={styles.detailItem}>
            <Icon name="people-outline" size={16} color={getColor('textTertiary')} />
            <Text style={[styles.detailText, { color: getColor('textSecondary') }]}>
