    ...
    >
      ...
      <View style={styles.imageContainer}>
        ...
        <View style={[styles.privacyBadge, { 
          ...
          {group.isPrivate ? (
            <Icon name="lock-closed" size={12} color={getColor('textPrimary')} />
          ) : (
            <Icon name="people" size={12} color={getColor('textPrimary')} />
          )}
        ...
        <View style={[styles.memberCount, { 
          ...
          <Icon name="people" size={14} color={getColor('textPrimary')} />
