  ...
  return (
    <View style={[styles.container, { backgroundColor: getColor('bg') }]}>
      ...
      <SafeAreaView style={styles.safeArea}>
        {/* Header */}
        <View style={[styles.header, { backgroundColor: getColor('surface') }]}>
          <View style={styles.headerContent}>
            {/* Location and Stats */}
            <View style={styles.locationSection}>
              <View style={styles.locationRow}>
                <Icon name="location" size={16} color={getColor('textPrimary')} />
              ...
              <View style={styles.statsRow}>
                <View style={styles.statItem}>
                  <Icon name="people" size={12} color={getColor('textTertiary')} />
                ...
                <View style={styles.statItem}>
                  <Icon name="notifications" size={12} color={getColor('textTertiary')} />
                  <Text style={[styles.statText, { color: getColor('textTertiary') }]}> 
                    {socialScore} score
                  </Text>
                </View>
            ...
            <View style={styles.actionButtons}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Icon name="notifications" size={20} color={getColor('textPrimary')} />
              </TouchableOpacity>
            </View>
          </View>
